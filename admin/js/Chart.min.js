...
function () {return function o(r, s, l) {
                function u(e, t) {
                    if (! s[e]) {
                        if (! r[e]) {
                        ...
                        r.prototype = {
                            ...
                            clone: function () {
                                var t,
                                    ...
                                    a = i.values;
                                for (var o in n) 
                                    n.hasOwnProperty(o) && (t = n[o], "[object Array]" === (e =
                    ...
                    function (t, e, i) {
                        ...
                        function u(t) {
                            var e = t[0] / 255,
                                ...
                                n = t[2] / 255;
                            return [
                                100 * (.4124 * (e = .04045 < e ? Math.pow((e + .055) / 1.055, 2.4) : e / 12.92) + .3576 * (i = .04045 < i ? Math.pow((i + .055) / 1.055, 2.4) : i / 12.92) + .1805 * (n = .04045 < n ? Math.pow((n + .055) / 1.055, 2.4) : n / 12.92)),
                        ...
                        function d(t) {
                            ...
                            [
                                116 * (n = .008856 < n ? Math.pow(n, 1 / 3) : 7.787 * n + 16 / 116) - 16,
                                500 * (i - n),
                                200 * (n - (a = .008856 < a ? Math.pow(a, 1 / 3) : 7.787 * a + 16 / 116))
                            ]
                        }
                        function c(t) {
                            var e,
                        ...
                        function v(t) {
                            ...
                            [
                                116 * (i = .008856 < i ? Math.pow(i, 1 / 3) : 7.787 * i + 16 / 116) - 16,
                                500 * (e - i),
                                200 * (i - (n = .008856 < n ? Math.pow(n, 1 / 3) : 7.787 * n + 16 / 116))
                            ]
                        }
                        function x(t) {
                            var e,
                        ...
                        e.exports = function (u) {
                            ...
                            h.extend(u.prototype, {
                                ...
                                handleEvent: function (t) {
                                    ...
                                    h.callback(n.onHover || n.hover.onHover, [
                                        t.native, i.active
                                    ], i),
                        ...
                        function (t, e, i) {
                            ...
                            e.exports = function () {
                                ...
                                g.configMerge = function () {
                                    return g.merge(g.clone(arguments[0]), [].slice.call(arguments, 1), {
                                        merger: function (t, e, i, n) {
                                            var a = e[t] || {},
                                                o = i[t];
                                            "scales" === t ? e[t] = g.scaleMerge(a, o) : "scale" === t ? e[t] = g.merge(a, [
                                ...
                                g.getRelativePosition = function (t, e) {
                                    ...
                                    return {
                                        x: i = Math.round(
                                            (i - r.left - l) / h * o.width / e.currentDevicePixelRatio
                                        ),
                                        y: n = Math.round(
                                            (n - r.top - u) / f * o.height / e.currentDevicePixelRatio
                                        )
                                    }
                                },
                ...
                33: [
                    function (t, e, i) {
                        ...
                        e.exports = n.extend({
                            ...
                            : H.noop, getPixelForValue
                            : H.noop, getValueForPixel
                            : H.noop, getPixelForTick
                            : function (t) {
                                var e = this,
                                    i = e.options.offset;
                                if (e.isHorizontal()) {
                    ...
                    if (!(isNaN(i) || i <= 0)) {
                        switch (t.save(), t.translate(n, a), t.rotate(o * Math.PI / 180), t.beginPath(), e) {
                            default: t.arc(0, 0, i, 0, 2 * Math.PI),
                                t.closePath();
                                break;
                            case "triangle": d = (s = 3 * i / Math.sqrt(3)) * Math.sqrt(3) / 2,
                                t.moveTo(- s / 2, d / 3),
                                t.lineTo(s / 2, d / 3),
                                t.lineTo(0, -2 * d / 3),
                                t.closePath();
                                break;
                            case "rect": c = 1 / Math.SQRT2 * i,
                                t.rect(- c, - c, 2 * c, 2 * c);
                                break;
                            case "rectRounded":
                                var h = i / Math.SQRT2,
                            ...
                            case "rectRot": c = 1 / Math.SQRT2 * i,
                                ...
                                t.closePath();
                                break;
                            case "cross": t.moveTo(0, i),
                                t.lineTo(0, - i),
                                t.moveTo(- i, 0),
                                t.lineTo(i, 0);
                                break;
                            case "crossRot": l = Math.cos(Math.PI / 4) * i,
                            ...
                            case "star": t.moveTo(0, i),
                                ...
                                t.lineTo(l, - u);
                                break;
                            case "line": t.moveTo(- i, 0),
                                t.lineTo(i, 0);
                                break;
                            case "dash": t.moveTo(0, 0),
                                t.lineTo(i, 0)
                        }
                        t.fill(),
                        t.stroke(),
    ...
    function (t, e, i) {
        ...
        var n,
            ...
            clone: function (t) {
                ...
                if (d.isObject(t)) {
                    for (var e =
                        {}, i = Object.keys(t), n = i.length, a = 0; a < n; ++ a) 
                        e[i[a]] = d.clone(t[i[a]]);
    ...
    function a(e, t, i) {
        var n,
            ...
            h = c.resizer = function (t) {
                ...
                a = a || this,
                o || (o =! 0, f.requestAnimFrame.call(window, function () {
                    o = !1,
                    n.apply(a, r)
                }))
            }));
    ...
    var t = n.extend({
        ...
        : function () {
            ...
            switch (p.ticks.source) {
                case "data": v = h._timestamps.data;
                    break;
                case "labels": v = h._timestamps.labels;
                    break;
                case "auto":
                default: v = D(f, g, h.getLabelCapacity(f), p)
            }
